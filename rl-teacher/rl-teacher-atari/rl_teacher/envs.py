...
class UnityGymWrapper(gym.Env):
    ...
    def _step(self, action):
        value = {}
        brain_info = self.env.step(action, value={self.brain_name: value})[self.brain_name]
        return brain_info.observations, brain_info.rewards, brain_info.local_done, {} #info
        """
        Returns:
